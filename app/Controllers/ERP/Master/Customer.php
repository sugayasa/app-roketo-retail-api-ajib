...
use App\Models\ERP\Master\CustomerModel;
...
class Customer extends ResourceController
{
    ...
    public function getList()
    {
        ...
        $baseData       =	$customerModel->select('IDCUSTOMER, NAMA, ALAMAT, TELPON, CATATAN, EDITABLE')->like('NAMA', $searchKeyword)->orLike('ALAMAT', $searchKeyword)->orLike('TELPON', $searchKeyword)->orLike('CATATAN', $searchKeyword);
