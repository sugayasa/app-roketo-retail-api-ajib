...
use App\Models\ERP\Stok\StokBarangModel;
...
class StokBarang extends ResourceController
{
    ...
    public function getDaftarStokBarangGudang()
    {
        ...
        $messages   =   [
            'idGudang'          =>  [
                'required'      =>  'Harap pilih salah satu gudang terlebih dahulu',
        ...
        if($totalNumberData > 0){
            ...
            $urlExcelStokGudang     =   base_url(URL_EXCEL_ERP_DATA_STOK_GUDANG).$arrParametersEncode;
    ...
    public function getDaftarStokBarangToko()
    {
        ...
        if($totalNumberData > 0){
            ...
            $arrParametersEncode=   encodeJWTToken($arrParameters);
            $urlExcelStokToko   =   base_url(URL_EXCEL_ERP_DATA_STOK_TOKO).$arrParametersEncode;
