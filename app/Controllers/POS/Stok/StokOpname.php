...
use App\Models\POS\Stok\StokOpnameModel;
...
class StokOpname extends ResourceController
{
     ...
     */
    use ResponseTrait;
    protected $userData, $idToko, $currentDateTime;
    protected $request;
    ...
    public function getListDataStokOpname()
    {
        ...
        $baseData           =   $stokOpnameModel->getDaftarStokOpnameRekap($this->idToko, $tanggalAwal, $tanggalAkhir, $kataKunciPencarian, $tampilBelumProses);
    ...
    public function checkStokSaveOpnameBarang()
    {
        ...
        $stokOpnameModel    =   new StokOpnameModel();
        $detailStokBarang   =   $stokOpnameModel->getDetailStokBarangOpname($this->idToko, $idStokOpnameRekap, $idStokOpnameBarang);
        ...
        $jumlahStokData     =   $stokOpnameModel->getJumlahStokDataBarang($this->idToko, $idBarangSKU, $idBarangSatuan);
        $jumlahSelisih      =   $jumlahStokFisik - $jumlahStokData;

        if($jumlahSelisih != 0){
            $idMutasiJenisStoko =   $jumlahSelisih > 0 ? 3 : 4; // 3=Stok Opname - Penambahan, 4=Stok Opname - Pengurangan
            ...
            $arrInsertStok      =   [
                ...
                'IDMUTASIJENISTOKO' =>  $idMutasiJenisStoko,
            ...
            $procInsertStokToko =   $mainOperation->insertDataTable('t_tokostok', $arrInsertStok);
