...
class MutasiBarangModel extends Model
{
    ...
    public function getDetailMutasiBarang($idToko, $tanggalAwal, $tanggalAkhir, $kataKunciPencarian)
    {	
    ...
    public function getRekapMutasiBarangPerTanggal($idToko, $tanggalAwal, $tanggalAkhir, $kataKunciPencarian)
    {	
        $this->select("DATE_FORMAT(A.INPUTTANGGALWAKTU, '%d %b') AS TANGGAL, COUNT(DISTINCT(A.IDTOKOSTOK)) AS JUMLAHMUTASI,
