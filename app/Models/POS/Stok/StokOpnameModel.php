...
class StokOpnameModel extends Model
{
    ...
    public function getDaftarStokOpnameRekap($idToko, $tanggalAwal, $tanggalAkhir, $kataKunciPencarian, $tampilBelumProses)
    {	
    ...
    public function getDetailStokBarangOpname($idToko, $idStokOpnameRekap, $idStokOpnameBarang)
    {	
    ...
    public function getJumlahStokDataBarang($idToko, $idBarangSKU, $idBarangSatuan)
    {	
